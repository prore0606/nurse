...
export const UPLOAD_TYPES: UploadTypeConfig[] = [
  ...
  },
  {
    id: "problems",
    label: "문제풀이",
    description: "문제와 5지선다 + 정답·해설을 일괄 등록",
    templateColumns: ["문제", "객관식 예문1", "객관식 예문2", "객관식 예문3", "객관식 예문4", "객관식 예문5", "정답", "해설"],
    columnDescriptions: ["문제 텍스트", "선택지 1", "선택지 2", "선택지 3", "선택지 4", "선택지 5 (선택)", "정답 번호 (1~5)", "해설 텍스트"],
  },
  {
    id: "videos",
    label: "영상",
