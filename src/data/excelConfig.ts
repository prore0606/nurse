...
export const UPLOAD_TYPES: UploadTypeConfig[] = [
  ...
  },
  {
    id: "problems",
    label: "문제풀이",
    description: "분류코드별 문제와 5지선다 + 정답·해설을 일괄 등록",
    templateColumns: ["분류코드", "문제유형", "문제", "객관식 예문1", "객관식 예문2", "객관식 예문3", "객관식 예문4", "객관식 예문5", "정답", "해설"],
    columnDescriptions: ["과목 내 분류 번호 (같은 코드끼리 한 섹션으로 묶임)", "1=객관식 (현재 객관식만 지원)", "문제 텍스트", "선택지 1", "선택지 2", "선택지 3", "선택지 4", "선택지 5 (선택)", "정답 번호 (1~5)", "해설 텍스트"],
  },
  {
    id: "videos",
    label: "영상",
